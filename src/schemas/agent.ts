...
export const createAgentSchema = z.object({
  ...
  temperature: z.coerce.number().min(0, 'Temperature must be at least 0').max(2, 'Temperature must be at most 2').default(0.7),
  systemPrompt: z.string().min(1, 'System prompt is required').max(5000, 'System prompt must be less than 5000 characters'),
